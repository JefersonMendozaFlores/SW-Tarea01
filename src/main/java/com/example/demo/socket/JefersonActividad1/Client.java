package com.example.demo.socket.JefersonActividad1;
...
public class Client {
	...
	public Client() {
		try {
			...
			System.out.println("-------- 1 Iniciando comunicación con la carpeta Origen ----------");
			
			File fileOrigen = new File("D:/Origen/Hola_Mundo.txt");
